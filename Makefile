...
run:
	docker run --rm -it --shm-size=512m -e DOMAIN_NAME=mydomain.com  -e DEBUG=true --name ubuntu -p 6912:443  -e USER_NAME=kasm-user -e VNC_PW=password changhui/ubuntu:${ide_tag} 