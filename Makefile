...
run:
	docker run --rm -it  --shm-size=512m -e DOMAIN_NAME=mydomain.com -e IP1=10.10.10.1  -e DEBUG=true --name ubuntu1 -p 6902:443 -p 2222:2222  -e USER_NAME=kasm-user -e VNC_PW=password changhui/ubuntu:${ide_tag} 