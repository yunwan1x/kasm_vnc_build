...
CHROME_ARGS="--password-store=basic  --ignore-gpu-blocklist --user-data-dir --no-first-run --simulate-outdated-no-au='Tue, 31 Dec 2099 23:59:59 GMT'"
...
rm edge.deb
#ls -an /usr/share/applications/microsoft-edge*
#ls -an /usr/bin/microsoft-edge-*
